      ...
      <form @submit.prevent="saveSettings" class="space-y-6">
        ...
        <ComponentCard title="General Settings">
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
              <label class="mb-2 block text-sm font-medium text-black dark:text-white">Check URL</label>
              <input
            ...
            <div>
              <label class="mb-2 block text-sm font-medium text-black dark:text-white">Timeout (seconds)</label>
              <input
            ...
            <div>
              <label class="mb-2 block text-sm font-medium text-black dark:text-white">IP Check Interval (minutes)</label>
              <input
                ...
                class="w-full rounded-md border border-stroke px-4 py-2 focus:border-primary focus:outline-none dark:border-strokedark dark:bg-meta-4"
              />
              <p class="mt-1 text-xs text-bodydark">How often to check proxy IPs (recommended: 15-30 min)</p>
            </div>
            <div>
              <label class="mb-2 block text-sm font-medium text-black dark:text-white">Speed Check Interval (minutes)</label>
              <input
                ...
                class="w-full rounded-md border border-stroke px-4 py-2 focus:border-primary focus:outline-none dark:border-strokedark dark:bg-meta-4"
              />
              <p class="mt-1 text-xs text-bodydark">How often to check proxy speeds (recommended: 60-360 min)</p>
            </div>
            <div>
            ...
            <div class="flex items-center">
              ...
              />
              <label for="skipSSL" class="text-sm font-medium text-black dark:text-white cursor-pointer">
        ...
        <ComponentCard title="Telegram Notifications">
          <div class="space-y-6">
            <div class="flex items-center justify-between">
              <div>
                <h4 class="font-medium text-black dark:text-white">Enable Telegram Notifications</h4>
                <p class="text-sm text-bodydark">Receive alerts about proxy status changes</p>
              </div>
            ...
            <div v-if="settings.telegramEnabled" class="space-y-4">
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <label class="mb-2 block text-sm font-medium text-black dark:text-white">Bot Token</label>
                  <input
                    ...
                    class="w-full rounded-md border border-stroke px-4 py-2 focus:border-primary focus:outline-none dark:border-strokedark dark:bg-meta-4"
                  />
                  <p class="mt-1 text-xs text-bodydark">Get from @BotFather on Telegram</p>
                </div>
                <div>
                  <label class="mb-2 block text-sm font-medium text-black dark:text-white">Chat ID</label>
                  <input
                    ...
                    class="w-full rounded-md border border-stroke px-4 py-2 focus:border-primary focus:outline-none dark:border-strokedark dark:bg-meta-4"
                  />
                  <p class="mt-1 text-xs text-bodydark">Your chat ID or channel ID</p>
                </div>
              </div>

              <div class="rounded-lg border border-stroke p-4 dark:border-strokedark">
                <h5 class="mb-3 font-medium text-black dark:text-white">Notification Types</h5>
                <div class="space-y-3">
                  <label class="flex items-center cursor-pointer">
                    ...
                    />
                    <div>
                      <span class="font-medium text-black dark:text-white">Proxy Down</span>
                      <p class="text-xs text-bodydark">Alert when proxy goes offline</p>
                    </div>
                  </label>
                  <label class="flex items-center cursor-pointer">
                    <input
                    ...
                    />
                    <div>
                      <span class="font-medium text-black dark:text-white">Proxy Recovery</span>
                      <p class="text-xs text-bodydark">Alert when offline proxy comes back online</p>
                    </div>
                  </label>
                  <label class="flex items-center cursor-pointer">
                    <input
                    ...
                    />
                    <div>
                      <span class="font-medium text-black dark:text-white">IP Change</span>
                      <p class="text-xs text-bodydark">Alert when proxy IP address changes</p>
                    </div>
                  </label>
                  <label class="flex items-center cursor-pointer">
                    <input
                    ...
                    />
                    <div>
                      <span class="font-medium text-black dark:text-white">IP Stuck</span>
                      <p class="text-xs text-bodydark">Alert when IP hasn't changed for >24 hours</p>
                    </div>
                  </label>
                  <label class="flex items-center cursor-pointer">
                    <input
                    ...
                    <div class="flex-1">
                      <div class="flex items-center justify-between">
                        <div>
                          <span class="font-medium text-black dark:text-white">Low Speed</span>
                          <p class="text-xs text-bodydark">Alert when speed drops below threshold</p>
                        </div>
                        <input
                  ...
                  <label class="flex items-center cursor-pointer">
                    ...
                    <div class="flex-1">
                      <div class="flex items-center justify-between">
                        <div>
                          <span class="font-medium text-black dark:text-white">Daily Summary</span>
                          <p class="text-xs text-bodydark">Daily report of proxy statistics</p>
                        </div>
                        <input
              ...
              <div class="flex gap-3">
                <button
                  ...
                  :disabled="!settings.telegramToken || !settings.telegramChatID || isTesting"
                ...
                >
                  <Send class="mr-2 h-4 w-4" :class="{ 'animate-pulse': isTesting }" />
