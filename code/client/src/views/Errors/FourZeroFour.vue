<template>
  ...
  >
    ...
    <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
      <h1
        class="mb-8 font-bold text-gray-800 text-title-md xl:text-title-2xl"
      >
        ERROR
      </h1>
      ...
      <p
        class="mt-10 mb-6 text-base text-gray-700 sm:text-lg"
      >
    ...
    <!-- Footer -->
    <p
      class="absolute text-sm text-center text-gray-500 -translate-x-1/2 bottom-6 left-1/2"
    >
