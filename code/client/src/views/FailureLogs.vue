                    ...
                    <span
                      :class="{
                        'bg-danger text-white':
                          log.error_type === 'ping_failed',
                        'bg-warning text-white':
                          log.error_type === 'speed_check_failed',
                  ...
                  <td colspan="5" class="px-4 py-8 text-center text-bodydark">
                    ...
                    {{
                      filters.proxyId || filters.errorType || filters.startDate
                        ...
                        : "Your proxies are working perfectly!"
                    }}
                  </td>
                </tr>
              </tbody>
...
const fetchStats = async () => {
  ...
  try {
    const response = await axios.get(
      `/api/failureStats/${filters.value.proxyId}`
    );
