    ...
    <div>
      ...
      <div class="relative">
        <input
          type="text"
          v-model="errorEmail"
          class=" w-full rounded-lg border border-error-300 bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-error-300 focus:outline-hidden focus:ring-3 focus:ring-error-500/10"
        />
    ...
    <div>
      ...
      <div class="relative">
        <input
          ...
          class=" w-full rounded-lg border border-success-300 bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-success-300 focus:outline-hidden focus:ring-3 focus:ring-success-500/10"
        />
        <span class="absolute right-3.5 top-1/2 -translate-y-1/2">
          <svg
            width="16"
